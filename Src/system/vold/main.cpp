...
//    coldboot("/sys/class/switch");
    ...
    //DEMO ONLY - Sebastian Hoebarth TODO DELETE
    /** test key... load original malster...
    testKey("f9cd8b30",0);
    int slots = cryptfs_key_slots();
    SLOGE("START keyslots: %d", slots);*/
    
    /** change pwd for key slot
    cryptfs_changepw_for_slot("test", "1"); 
    testKey("test",1);*/
    
    /** delete key slot
    cryptfs_remove_key_slot("1");
    SLOGE("Found keyslots: %d", slots);*/
    
    /** add key slot
    cryptfs_add_key_slot("1234");
    slots = cryptfs_key_slots();
    SLOGE("Found keyslots after: %d", slots);*/
